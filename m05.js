...
// Do multiplication
while (i < 11) {
  msg += i + ' x ' + table + ' = ' + (i * table).toFixed ( table.length - decimal - 1 ) + '<br />';  // .toFixed ( table.length  - 1 ) is to round the answer of i * table to the correct answer.  Java seems to have an issue with multipling decimals by 3, 6, & 7.  For example, 3 * 12.2 is 36.599999999999994
  i++;
}
